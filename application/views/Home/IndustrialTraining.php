                        ...
                        <div class="col-lg-3 col-md-4 col-sm-12 m-b30">
                            <div class="course-detail-bx text-center" id="flaxdiv">
                                <!-- <div class="course-price row">
                                        ...
                                        <div class="col-6">
                                        <h6>Offer Price:</h6>
                                        <h6 class="price text-success">₹8000</h6>
                                        </div>
                                    </div> -->
                            ...
                            <div class="courses-post">
                                <div class="ttr-post-info">
                                    <div class="ttr-post-title ">
                                        <h2 class="post-title">About Our Industrial Training Program</h2>
                                    </div>
                                    <div class="ttr-post-text">
                                        <p>Industrial Training program is specially designed only for B.Tech MCA Final
                                            Year Students Engineering Students , who wants to explore the IT Industry
                                            and want to start their career as Software Engineer, Website or Mobile
                                            Application Developer. This is a four months training program with live
                                            projects held in Jan-Apr.</p>
                                        <p>We at DigiCoders Technologies offers various training program and development
                                            platforms to learn and explore the technology, All training programs at
                                            DigiCoders contains latest information technology version as well as latest
                                            frameworks will all components. We have Industry Expert Trainers and
                                            Developers to Give Students Live Projects Based Exposer.</p>
                                    </div>
                                </div>
                            </div>
