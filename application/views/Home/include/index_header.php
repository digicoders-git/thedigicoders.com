<div class="page-wraper">
    ...
    <!-- Header Top ==== -->
    <header class="header rs-nav header-transparent" style="background-color: rgba(0,0,0,0.9);">
        <div class="top-bar">
            <div class="container">
                <div class="row d-flex justify-content-between">
                    <div class="topbar-left">
                        <ul>
                            <li><i class="fa-solid fa-mobile-screen-button"></i><a href="tel:+91 9198483820"><span
                                        class="text-white">+91
                                        9198483820</span></a></li>
                            <!-- <li><a href="javascript:void(0)"  onclick="Enquiry()" ><i class="fa-solid fa-circle-question"></i>Ask a Question</a></li>
                          <li><a href="mailto:info@thedigicoders.com" target="_blank"><i class="fa-regular fa-envelope"></i>info@thedigicoders.com</a></li>-->
                    ...
                    <div class="topbar-right">
                        <ul>
                            <li><a href="<?= base_url('public') ?>/assets/images/DigiCoders_2026_Company_Profile.pdf"
                                    target="_blank" download onclick="openSocial()"><i class="fa-solid fa-download"></i>
                            ...
                            <li><a href="<?= base_url('public') ?>/assets/images/DigiCoders_2026_Placement_Brochure.pdf"
                                    target="_blank" download onclick="openSocial()"><i class="fa-solid fa-download"></i>
                                    Placement Broucher</a></li>
                            <!-- @*<li><a href="<?= base_url() ?>Home/FeePayment">Fee Payment</a></li>*@ -->
                            <li><a href="<?= base_url() ?>Home/Registration"><i class="fa-solid fa-pencil"></i>
        ...
        <!--<audio controls style="display: none;">	
                    <source src="<?= base_url('public') ?>/assets/audio/training1.mpeg" type="audio/mpeg">
            </audio>
                ...
                <div class="container clearfix">
                    ...
                    <div class="menu-logo logo-change">
                        <a href="<?= base_url() ?>Home/Index"><img
                                ...
                                alt="DigiCoders logo" title="DigiCoders logo"></a>
                    </div>
                    <!-- Mobile Nav Button ==== -->
                    ...
                    <div class="menu-links navbar-collapse collapse justify-content-end" id="menuDropdown">
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li>
                                <a href="javascript:;">About<i class="fa-solid fa-chevron-down"></i></a>
                                <ul class="sub-menu">
                            ...
                            <li>
                                <a href="javascript:;">Training<i class="fa-solid fa-chevron-down"></i></a>
                                <ul class="sub-menu">
                            ...
                            <li>
                                <a href="javascript:;">Gallery <i class="fa-solid fa-chevron-down"></i></a>
                                <ul class="sub-menu">
                            ...
                            <li>
                                <a href="javascript:;">More<i class="fa-solid fa-chevron-down"></i></a>
                                <ul class="sub-menu">
                            ...
                            <li>
                                <a href="javascript:;">Our Services<i class="fa-solid fa-chevron-down"></i></a>
                                <ul class="sub-menu">
                                    <!--<li><a target="_blank" href="https://digicoders.in/Home/ITServices"><span>All Services</span></a></li>-->
                                    <li><a target="_blank"
                                            href="https://digicoders.in/Home/SoftwareDevelopment"><span>Software
                                                Development</span></a></li>
                                    <li><a target="_blank"
                                            href="https://digicoders.in/Home/WebsiteDevelopment"><span>Website
                                                Development</span></a></li>
                                    <li><a target="_blank"
                                            href="https://digicoders.in/Home/MobileApplicationDevelopment"><span>Mobile
                                                App Development</span></a></li>
                                    <li><a target="_blank"
                                            href="https://digicoders.in/Home/DigitalMarketing"><span>Digital
                                                Marketing</span></a></li>
                                    <li><a target="_blank"
                                            href="https://digicoders.in/Home/GraphicsDesigning"><span>Graphics
                                                Designing</span></a></li>
                                    <li><a target="_blank"
                                            href="https://digicoders.in/Home/DomainAndHosting"><span>Domain &amp;
                                                Hosting</span></a></li>
                                    <li><a target="_blank"
                                            href="https://digicoders.in/Home/ERPandCRMDevelopment"><span>ERP &amp; CRM
                                                Development</span></a></li>
                                    <li><a target="_blank"
                                            href="https://digicoders.in/Home/MaintenanceServices"><span>Maintenance
                                                Services</span></a></li>

                                </ul>
                            </li>
                        </ul>
                        <div class="nav-social-link fafaicon">
                            <a target="_blank" href="https://www.facebook.com/DigiCodersTech/" aria-label="facebook"><i
                                    class="fa-brands fa-facebook-f"></i></a>
                            <a target="_blank" href="https://twitter.com/DigiCodersTech/" aria-label="twitter"><i
                                    class="fa-brands fa-x-twitter"></i></a>
                            <a target="_blank" href="https://www.linkedin.com/in/digicoders/" aria-label="linkedin"><i
                            ...
                            <a target="_blank" href="https://instagram.com/digicoderstechnologies/"
