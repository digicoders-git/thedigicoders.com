...
<head>
    ...
    <title><?= $course_name ?> | Best IT/CS Training Institute - DigiCoders Technoloies</title>
    ...
    <section class="city-services">
        <div class="container">
            <div class="section-header">
                <h2>Our Services</h2>
                <p>Comprehensive IT training solutions tailored for students and professionals</p>
            </div>
            ...
            <div class="services-grid">
                <div class="service-card fade-in">
                    ...
                    <p>Customized IT training programs for corporate teams </p>
                </div>
                ...
                <div class="service-card fade-in">
                    ...
                    <p>Paid internship opportunities with IT companies </p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="text-center">
                ...
                <div class="cta-buttons">
                    ...
                    <a href="<?= base_url('Home/Contact') ?>" class="btn-light">
                        <i class="fas fa-map-marker-alt me-2"></i> Visit Our Center
                    </a>
                </div>
