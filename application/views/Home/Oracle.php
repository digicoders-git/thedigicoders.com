			...
			<div class="page-banner ovbl-dark" style="background-image:url(<?= base_url('public') ?>/assets/images/banner/15august.jpeg);">
				<div class="container">
					<div class="page-banner-entry">
						<h1 class="text-white">Oracle Training In Lucknow</h1>
					</div>
				</div>
			</div>
						...
						<div class="row d-flex flex-row-reverse">
							...
							<div class="col-lg-9 col-md-8 col-sm-12">
								...
								<ul class="nav nav-pills mb-3 mt-5">
									...
									<li class="nav-item mr-3 mb-3" role="presentation">
										<a href="<?= base_url('public') ?>/Syllabus/Vocational Training/ASP.Net Syllabus 45 Days.pdf" onclick="OpenSocialModal()" class="nav-link active" download=""><i class="fa fa-file-pdf-o"></i> Download <br />
											<center style="font-size:12px;">Oracle</center>
										</a>
									</li>
									<!--<li class="nav-item mr-3 mb-3" role="presentation">
								...
								<ul class="nav nav-pills mb-3 mt-5" id="pills-tab" role="tablist">
									...
									<li class="nav-item" role="presentation">
										<a class="nav-link" id="pills-asp-tab" data-toggle="pill" href="#pills-asp" role="tab" aria-controls="pills-asp" aria-selected="false">Oracle</a>
									</li>
									<!--<li class="nav-item" role="presentation">
