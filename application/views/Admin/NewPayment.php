...
<html lang="en">
	...
	<head>
		<title>Fee Payement List - <?= $this->data['app_name'] ?></title>
						...
						<div class="row align-items-center m-0">
							...
							<div class="col-sm-9 text-end"> 
								...
								<form method="get"> 
									...
									<a href="<?= base_url('Admin/NewPayment')?>" class="btn-success py-1 px-2"><i class="fa fa-refresh"></i></a>
								</form>
...
<script>
	...
	function CollegeCode(){
		...
		// alert(x);
		window.location.href="<?= base_url('Admin/NewPayment?code=')?>" + x;
	}
