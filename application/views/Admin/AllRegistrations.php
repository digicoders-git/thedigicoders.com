...
<html lang="en">
	...
	<head> 
		<title>All Registration List - <?= $this->data['app_name'] ?></title>
		...
		<div class="wrapper">
			...
			<main class="page-content">
				...
				<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
					<div class="breadcrumb-title pe-3"> All Registration List</div>
					<div class="ps-3">
											...
											<tr>
												...
												<td>
													<div class="col">
														<div class="col">
															<div class="btn-group">
																<button type="button" data-bs-toggle="tooltip" data-bs-placement="top" title="Reject" onclick="AcceptReg('registration',<?= $data->id ?>,'reject','<?= base_url('Admin/ChangeAcceptStatus') ?>')" class="btn btn-dark btn-sm"><i class="bi bi-x-circle"></i></button>
																<a type="button" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit" href="<?= base_url('Admin/EditRegDetails/').$data->id ?>" class="btn btn-danger btn-sm"><i class="bi bi-pencil-square"></i></a>
															</div>
														</div>
													</div>
												</td>
												...
												<td>
													<div class="col">
														...
														<a onclick="EditData('registration', <?= $data->id ?>, 'Edit Payment Status')" type="button" class=""><i class="bi bi-pencil-square"></i></a>
													</div> 
												</td>
												<td>
													<div class="col">
														<a href="<?= base_url() ?>Home/Receipt/<?= $data->id  ?>" target="_blank" type="button" class="btn btn-outline-info btn-sm ">
...
<script>
	...
	function CollegeCode(){
		...
		window.location.href="<?= base_url('Admin/RegistrationAccepted?code=')?>" + x;
	}
