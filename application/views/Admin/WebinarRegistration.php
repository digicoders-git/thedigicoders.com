...
<head>
    <title>Webinar Registration - <?= $this->data['app_name'] ?></title>
    ...
    <div class="wrapper">
        ...
        <main class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3">Webinar Registration </div>
                <div class="ps-3">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <!--td>
                                            <div class="col">
                                                <div class="btn-group">
                                                    <button type="button" onclick="deleteItem(<?= $data->id ?>,'webinar_registration','','<?= base_url('Admin/deleteWithFilename') ?>')" class="btn btn-danger"><i class="bi bi-trash"></i></button>
