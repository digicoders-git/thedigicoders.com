...
<head>
	<title>Registration List - <?= $this->data['app_name'] ?></title>
			...
			<div class="card">
				<div class="card-header py-3">
					<div class="row align-items-center m-0">
						<h6>New Registration List (Pending)</h6>
					</div>
										...
										<tr>
											...
											<td>
												<div class="col">
													...
													?><a onclick="EditData('registration', <?= $data->id ?>, 'Edit Payment Status')" type="button" class=""><i
...
<script>
	...
	function CollegeCode() {
		...
		window.location.href = "<?= base_url('Admin/Registration?code=') ?>" + x;
	}
