                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="col">
                                                <div class="btn-group">
                                                    <button type="button"onclick="deleteItem(<?= $data->id ?>,'teamexpert','<?= $data->Image ?>','<?= base_url('Admin/deleteWithFilename') ?>')" class="btn btn-danger" >
                                        ...
                                        <td>
											...
											<div class="form-check form-switch">
													<input class="form-check-input" type="checkbox" onchange="ChnageStatus('<?= $data->id ?>','<?= $data->status ?>','teamexpert','<?= base_url('Admin/ChangeStatus') ?>')" id="flexSwitchCheckChecked" <?php if ($data->status == 'true')
														{
															echo "checked";
														} ?>>
                                        ...
                                        <td> <img src="<?= base_url('public/uploads/teamexpert/') . $data->Image; ?>" alt="ddd" style="height: 120px; weight: 100%" /> </td>
                                        <td><?= $data->Date; ?></td>
                                        <td><?= $data->Time; ?></td>
    ...
    <div class="modal-dialog ">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url() ?>Admin/expert/add" enctype="multipart/form-data" method="POST" class="form" id="gallery-form">
