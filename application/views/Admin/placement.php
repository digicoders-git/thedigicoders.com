			...
			<div class="card">
				<div class="card-header py-3">
					<div class="row align-items-center m-0">
						<div class="col-sm-6">
							<h6>Manage Recent placement</h6>
						</div>
						<div class="col-sm-6">
							<div class="d-grid gap-2 d-md-flex justify-content-md-end">
								<button class="btn btn-primary me-md-2" type="button" data-bs-toggle="modal"
									data-bs-target="#galleryModal"><i class="fa fa-plus"></i>&ensp;Add Picture</button>
									...
									<tr>
										...
										<td>
											<div class="col">
												<div class="btn-group">
													<button type="button"
														onclick="deleteItem(<?= $data->id ?>,'placement','<?= $data->photo ?>','<?= base_url('Admin/deleteWithFilename') ?>')"
														class="btn btn-danger"><i class="bi bi-trash"></i></button>
													<button type="button"
														onclick="EditData('placement',<?= $data->id ?>,'Edit Picture')"
														class="btn btn-primary"><i class="bi bi-pencil-square"></i></button>
												</div>
											</div>
										</td>
										<td>
											<div class="form-check form-switch">
												<input class="form-check-input" type="checkbox"
													onchange="ChangeStatus(<?= $data->id ?>,'<?= $data->status ?>','placement','<?= base_url('Admin/ChangeStatus') ?>')"
										...
										<td> <img src="<?= base_url('public/uploads/placement/') . $data->photo; ?>"
												alt="ddd" style="height: 120px; weight: 100%" /> </td>
	...
	<div class="modal-dialog ">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="<?= base_url() ?>Admin/placement/Add" enctype="multipart/form-data" method="POST"
