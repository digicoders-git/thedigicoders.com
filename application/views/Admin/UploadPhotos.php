...
<head>
    <title>Manage Photos - <?= $this->data['app_name'] ?></title>
    ...
    <div class="wrapper">
        ...
        <main class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3">Upload Events Photos</div>
                <div class="ps-3">
                    ...
                    <div class="table-responsive">
                        <table id="example2" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                <tr>
                                    <td>1</td>
                                    <td><img src="https://www.chromahouse.com/wp-content/uploads/2020/04/miami-corporate-event-video.jpg" class="w-25 img-fluid"/></td>
                                    <td>Farewell</td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
                <h5 class="modal-title" id="exampleModalLabel">Upload Event Photographs</h5>
                        ...
                        <div class="row">
                            <div class="col-sm-12 d-grid">
                                <div class="form-group mb-3">
                                    <label for="batch">Upload Image</label>
                                    <input type="file" class="form-control" />
                                </div>
                                <div class="form-group mb-3">
                                    <label for="batch">Event Name</label>
...
<div class="modal fade" id="edit_assigngment" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
                <h5 class="modal-title" id="exampleModalLabel">Edit Event Photographs</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form action="<?= base_url() ?>Admin/ManageBatch/Add" enctype="multipart/form-data" method="POST"
