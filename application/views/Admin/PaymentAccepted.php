...
<html lang="en">
	...
	<head>
		<title>Accept Fee Payement List - <?= $this->data['app_name'] ?></title>
				...
				<div class="card">
					<div class="card-header py-3">
						<div class="row align-items-center m-0">
							...
							<h6>Accept Fee Payement List</h6>
							<!-- </div> -->
						...
						<div class="row align-items-center m-0">
							...
							<div class="col-sm-9 text-end"> 
								...
								<form method="get"> 
									...
									<a href="<?= base_url('Admin/PaymentAccepted')?>" class="btn-success py-1 px-2"><i class="fa fa-refresh"></i></a>
								</form>
									...
									<?php
										...
										$regdata=$this->db->get_where("registration",['id'=>$data->reg_id])->row();
											...
											<tr>
												...
												<td><?= $regdata->college_name; ?></td>
												<td><?= $regdata->couponcode; ?></td>
												<td><?= $regdata->edu_year; ?></td>
...
<script>
	...
	function CollegeCode(){
		...
		// alert(x);
		window.location.href="<?= base_url('Admin/PaymentAccepted?code=')?>" + x;
	}
