		...
		<div class="wrapper">
			...
			<main class="page-content">
				...
				<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
					<div class="breadcrumb-title pe-3">ManageTechnology</div>
					<div class="ps-3">
				...
				<div class="card">
					<div class="card-header py-3">
						<div class="row align-items-center m-0">
							<div class="col-6">
								<h6>ManageTechnology</h6>
							</div>
							<div class="col-6">
								<div class="d-grid gap-2 d-md-flex justify-content-md-end">
									<button class="btn btn-primary me-md-2" type="button" data-bs-toggle="modal" data-bs-target="#EventModal"><i class="fa fa-plus"></i>&ensp;Add Technology</button>
									...
									<?php
										...
										<tr>
											...
											<td>
												<div class="col">
													<div class="btn-group">
														<button type="button" onclick="deleteItem(<?= $data->id ?>,'technology','<?= $data->image ?>','<?= base_url('Admin/deleteWithFilename') ?>')" class="btn btn-danger"><i class="bi bi-trash"></i></button>
														
														<button onclick="EditData('technology', <?= $data->id ?>, 'Edit Technology')" type="button" class="btn btn-primary "><i class="bi bi-pencil-square"></i></button>
													</div>
												</div>
											</td>
											
											<td> <a href="<?= base_url('public/uploads/technology/') . $data->image; ?>"> <img src="<?= base_url('public/uploads/technology/') . $data->image; ?>" alt="" style="height: 150px;width:150px"></a></td>
		...
		<div class="modal-dialog ">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="<?= base_url() ?>Admin/ManageTechnology/Add" enctype="multipart/form-data" method="POST" class="form" id="add-event">
						...
						<div class="form-group mb-3">
							<input type="text" id="input-file-now" name="technology_name" class="form-control" placeholder="Technology Name" required />
						</div>
