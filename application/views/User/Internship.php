...
<head>
	<title>My Internship Letter - Software Development | Website Development | Mobile Application Development | Digital
			...
			<div class="row d-flex justify-content-center">
				<div class="col-sm-10 mt-5">
					...
					<div class="card text-bg-dark">
						<img src="<?= base_url('public/assets/images/internship-later-2025.png') ?>" class="card-img"
							alt="...">
						<div class="card-img-overlay">
							...
							<div class="box_80">
								<!-- <div class="d-flex justify-content-between">
									<div class="date">
										<h5 class="fw-bold">Date: <span
												style="color:#e76028"><?= !empty($internship->date) ? date('d/m/Y', strtotime($internship->date)) : ''; ?></span>
										</h5>
									</div>
									<div class="date">
								...
								<!-- <h4 class="fw-bold stu_name" style="color:#e76028">
									<?= !empty($internship->student_name) ? $internship->student_name : ''; ?>,
								</h4> -->
								<!-- <p class="description">We would like to congratulate you on being selected for the
									...
									<div class="d-flex justify-content-between pb-2 f-size">
										...
										<p class="mb-0">REF NO: <span>DCT/2025/<?= !empty($internship->id)? $internship->id : ""; ?></span></p>
									</div>
								<p class="p-fromat">DEAR<span
										class="pl3"><b><?= !empty($internship->student_name) ? $internship->student_name : ''; ?>,</b></span>
								</p>
								<p class="p-fromat">
									We are pleased to offer you an internship opportunity at <b>DigiCoders
										Technologies</b> for
									a duration of 6 Months, starting in the month of June & July 2025. This internship
									is designed to provide you with structured training aimed at enhancing your
									understanding of real-world applications in your field of study. You will have the
									chance to work on projects that will help you apply your academic knowledge in a
									practical setting, giving you valuable hands-on experience.
								</p>
								<p class="p-fromat mb-0 pb-0">Throughout the internship, you will be guided and mentored by
									experienced
									professionals who are committed to supporting your growth and development. Our goal
									is to provide a collaborative and engaging environment where you can build your
									skills, gain meaningful insights into industry practices, and make a positive
									contribution to our team.</p>

									<center><b class="p-fromat mt-3">We have team of 10+ years of experienced professionals.</b></center>
