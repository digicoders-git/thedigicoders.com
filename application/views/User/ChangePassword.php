...
<html lang="en">
	...
	<head>
		<title>Change Password - Software Development | Website Development | Mobile Application Development | Digital
			Marketing |
						...
						<div class="card">
							<div class="card-header py-3">
								<div class="row">
									...
									<div class="row mt-4">
										<div class="col-sm-12">
											<form action="<?= base_url('User/ChangePassword/Code')?>" method="POST">
												<div class="mb-3">
													<label for="old_password" class="form-label">Old Password</label>
													<input type="text" class="form-control" name="opass" placeholder="Enter Old Password" required>
												</div>
												<div class="mb-3">
